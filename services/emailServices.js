        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div style="text-align: center;">
                    <a href="${process.env.FRONTEND_URL || 'www.airuter.com'}/candidate/login" class="button">
...
const sendPasswordResetEmail = async (candidateEmail, candidateName, resetToken) => {
  try {
    const transporter = createTransporter();
    const resetUrl = `${process.env.FRONTEND_URL || 'www.airuter.com'}/candidate/reset-password/${resetToken}`;
